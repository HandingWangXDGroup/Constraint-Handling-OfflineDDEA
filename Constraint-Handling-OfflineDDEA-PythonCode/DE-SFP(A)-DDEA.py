...
class DE():
    ...
    def selection(self, fit_value, fit_cons1, fit_cons2):
        ...
        fit_cons1 = fit_cons1/abs(min(fit_cons1))
        fit_cons2 = fit_cons2/abs(min(fit_cons2))
        for i in range(self.pop_size):
            ...
            fitnessj2 = np.square(min(0, fit_cons1[i + self.pop_size])) + np.square(
                min(0, fit_cons2[i + self.pop_size]))
